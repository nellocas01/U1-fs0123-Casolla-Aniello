...
/* ESERCIZIO 5
 ...
 for(let personaggio of starWarsCharacters){
  switch(personaggio.eye_color){
    case "blue":
      eyeColor.blue.push(personaggio.eye_color);
      break;
      case "yellow":
      eyeColor.yellow.push(personaggio.eye_color);
      break;
      case "brown":
      eyeColor.brown.push(personaggio.eye_color);
      break;
      case "red":
      eyeColor.red.push(personaggio.eye_color);
      break;
      case "blue-grey":
      eyeColor.blue_gray.push(personaggio.eye_color);
      break;
  }
 }
...
let i = 0;
let massa = 0;
for(let personaggio of starWarsCharacters.mass)
while(i < starWarsCharacters.length){
  massa + personaggio.mass; 
  i++;
}
