...
/* ESERCIZIO A
  Crea una variabile chiamata "sum" e assegnaci il risultato della somma tra i valori
   10 e 20.
*/
{
  let x = 10;
...
/* ESERCIZIO B
  Crea una variabile chiamata "random" e assegnaci un numero casuale tra 
  0 e 20 (deve essere generato dinamicamente a ogni esecuzione).
*/
{
...
/* ESERCIZIO 6
  ...
  prendere online (regex per email)
*/
...
isThisAnEmail('nellocas@gmail.com');
/* ESERCIZIO 7
...
/* ESERCIZIO 8
  ...
  il suo valore deve rappresentare il totale di tutti i valori estratti con le invocazioni
   di dice().
